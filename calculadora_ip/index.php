...
<html>
    ...
    <body>
        ...
        <form method="post" class="form">
            <label for="#">Endereço IP / Prefixo CIDR: <small style="color: #fd5708;"> (Ex.: 192.168.0.1/24)</small></label>
                <div class="divider"></div>

            <input type="text" class="form-control input_text" name="ip" value="<?php echo @$_POST['ip'];?>">
                <div class="divider"></div>
